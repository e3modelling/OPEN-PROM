# Warning
You can move directly to Tutorial named 03_First OPEN-PROM running if you want to test the model with dummy data and come back later here. This guide is needed to run the model with real data as it will be explained in 05_Running OPEN-PROM with real data input

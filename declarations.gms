...
iEffValueInEuro(allCy,SBS,YTIME)	            "Efficiency value (Euro2015/toe)"
...
iHydrogenPri(allCy,SBS,YTIME)	                "Total Hydrogen Cost Per Sector (Euro2015/toe)"
...
iCarbValYrExog(allCy,ytime)	                    "Carbon value for each year when it is exogenous (Euro2015/tn CO2)"
...
iVarCostTech(allCy,SBS,EF,YTIME)	            "Variable Cost of technology ()"
                                                    !! For transport (kEuro2015/vehicle)
                                                    !! For Industrial sectors, except Iron and Steel (Euro2015/toe-year)
                                                    !! For Iron and Steel  (Euro2015/tn-of-steel)
                                                    !! For Domestic sectors  (Euro2015/toe-year)
iFixOMCostTech(allCy,SBS,EF,YTIME)              "Fixed O&M cost of technology (Euro2015/toe-year)"                                   
                                                    !! Fixed O&M cost of technology for Transport (kEuro2005/vehicle)
                                                    !! Fixed O&M cost of technology for Industrial sectors-except Iron and Steel (Euro2015/toe-year)"                                            
                                                    !! Fixed O&M cost of technology for Iron and Steel (Euro2015/tn-of-steel)"                                          
                                                    !! Fixed O&M cost of technology for Domestic sectors (Euro2015/toe-year)"
iUsfEneConvSubTech(allCy,SBS,EF,YTIME)          "Useful Energy Conversion Factor per subsector and technology (1)"
iInvCostChp(allCy,DSBS,CHP,YTIME)               "Capital Cost per CHP plant type (kEuro2015/KW)"
iFixOMCostPerChp(allCy,DSBS,CHP,YTIME)          "Fixed O&M cost per CHP plant type (Euro2015/KW)"
iVarCostChp(allCy,DSBS,CHP,YTIME)               "Variable (other than fuel) cost per CHP Type (Gross Euro2015/KW)"
...
iCapCostTech(allCy,SBS,EF,YTIME)                "Capital Cost of technology (various)"
                                                    !! - For transport is expressed in kEuro2015 per vehicle
                                                    !! - For Industrial sectors (except Iron and Steel) is expressed in kEuro2015/toe-year
                                                    !! - For Iron and Steel is expressed in kEuro2015/tn-of-steel
                                                    !! - For Domestic Sectors is expressed in kEuro2015/toe-year
...
QCostTranspPerMeanConsSize(allCy,TRANSE,RCon,TTECH,YTIME)  "Compute transportation cost per mean and consumer size in KEuro2015 per vehicle"
...
QCostTranspPerVeh(allCy,TRANSE,RCon,TTECH,YTIME)	       "Compute transportation cost per mean and consumer size in KEuro2015 per vehicle"
...
vCostHourProdInvCCS(allCy,PGALL,HOUR,YTIME)                "Hourly production cost of technology accounting for CCS acceptance (Euro2015/KWh)"
VShareRenGrossProd(allCy,YTIME)	                           "Renewables share in gross electricity production for subsdidized renewables"
VCostPowGenLngTechNoCp(allCy,PGALL,ESET,YTIME)	           "Long-term average power generation cost (Euro2015/kWh)"
...
VCostVarTechNotPGSCRN(allCy,PGALL,YTIME)                   "Variable cost of technology excluding PGSCRN (Euro2015/KWh)"
vCostPowGenAvgShrt(allCy,ESET,YTIME)                       "Short-term average power generation cost (Euro2015/kWh)"	
VCostPowGenAvgLng(allCy,ESET,YTIME)	                       "Long-term average power generation cost (Euro2015/kWh)"	
vCostPowGenLongIntPri(allCy,PGALL,ESET,YTIME)              "Long term power generation cost of technologies including international prices of main fuels (kEuro2015/toe)"
VRenShareElecProdSub(allCy,YTIME)	                       "Renewables share in gross electricity production for subsdidized renewables (1)"	 
VPriceElecIndResNoCliPol(allCy,ESET,YTIME)                 "Electricity price to Industrial and Residential Consumers (Euro2015/KWh)"	
VCostPowGenLonNoClimPol(allCy,ESET,YTIME)                  "Long-term average power generation cost  excluding climate policies (Euro2015/kWh)"	
VCostAvgPowGenLonNoClimPol(allCy,PGALL,ESET,YTIME)	       "Long-term average power generation cost excluding climate policies(Euro2015/kWh)" 	
vCostPowGenShortIntPri(allCy,PGALL,ESET,YTIME)             "Short term power generation cost of technologies including international Prices of main fuels (kEuro2015/toe)"		
vCostPowGenLonMin(allCy,PGALL,YTIME)	                   "Long-term minimum power generation cost (Euro2015/kWh)"	
...
VCostHourProdInvDec(allCy,PGALL,HOUR,YTIME)                "Hourly production cost of technology (Euro2015/KWh)"
VProdEstElecCHP(allCy,YTIME)	                           "Estimate the electricity of CHP Plants (1)"	
VCostProdSpecTech(allCy,PGALL,YTIME)	                   "Production cost of technology (Euro2015/KWh)"
...
VCostVarTechElec(allCy,PGALL,YTIME)	                       "Variable cost of technology (Euro2015/KWh)"	
...
VCostProdTeCHPreReplac(allCy,PGALL,YTIME)                  "Production cost of technology used in premature replacement (Euro2015/KWh)"
...
VCostVarTech(allCy,PGALL,YTIME)	                           "Variable cost of technology (Euro2015/KWh)"	
...
VCostHourProdInvDecNoCCS(allCy,PGALL,HOUR,YTIME)           "Hourly production cost of technology (Euro2015/KWh)"	
VCostProdTeCHPreReplacAvail(allCy,PGALL,PGALL2,YTIME)	   "Production cost of technology used in premature replacement including plant availability rate (Euro2015/KWh)"		
...
VCostTranspPerMeanConsSize(allCy,TRANSE,RCon,TTECH,YTIME)  "Transportation cost per mean and consumer size (Keuro2015/vehicle)"
VCostTranspPerVeh(allCy,TRANSE,RCon,TTECH,YTIME)	       "Transportation cost per mean and consumer size (Keuro2015/vehicle)"
VCostTranspMatFac(allCy,TRANSE,RCon,TTECH,YTIME)	       "Transportation cost including maturity factor (Keuro2015/vehicle)"	
...
VCostElecProdCHP(allCy,DSBS,CHP,YTIME)                     "Electricity production cost per CHP plant and demand sector (Euro2015/KWh)"
VCostTech(allCy,DSBS,rCon,EF,YTIME)                        "Technology cost (Keuro2015/toe)"
VCostTechIntrm(allCy,DSBS,rcon,EF,YTIME)                   "Intermediate technology cost (Keuro2015/toe)"
VCostTechMatFac(allCy,DSBS,rCon,EF,YTIME)                  "Technology cost including maturity factor (Keuro2015/toe)"
...
VCostProdCHPDem(allCy,DSBS,CHP,YTIME)                      "Variable including fuel electricity production cost per CHP plant and demand sector (Euro2015/KWh)"
VCostElcAvgProdCHP(allCy,CHP,YTIME)                        "Average Electricity production cost per CHP plant (Euro2015/KWh)"
VCostVarAvgElecProd(allCy,CHP,YTIME)                       "Average variable including fuel electricity production cost per CHP plant (Euro2015/KWh)"
...
*' *** Prices Variables
VPriceElecIndResConsu(allCy,ESET,YTIME)	                   "Electricity price to Industrial and Residential Consumers (Euro2015/KWh)"
VPriceFuelSepCarbonWght(allCy,SBS,EF,YTIME)	               "Fuel prices per subsector and fuel  mutliplied by weights (kdollars2005/toe)"	
VAvgPowerGenLongTrm(allCy,ESET,YTIME)	                   "Long-term average power generation cost (Euro2015/kWh)"	 
...
VCstCO2SeqCsts(allCy,YTIME)	                               "Cost curve for CO2 sequestration costs (Euro2015/tn of CO2 sequestrated)"
...
Positive Variables
VCarVal(allCy,NAP,YTIME)                                   "Carbon prices for all countries (Euro2015/tn CO2)"
VRenValue(YTIME)                                           "Renewable value (Euro2015/KWh)"
;

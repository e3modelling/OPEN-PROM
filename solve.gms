...
VConsElecIndTertNonSub.FX(allCy,DSBS,YTIME)$TIME(YTIME) = VConsElecIndTertNonSub.L(allCy,DSBS,YTIME)$TIME(YTIME);
VDemSub.FX(allCy,DSBS,YTIME)$TIME(YTIME) = VDemSub.L(allCy,DSBS,YTIME)$TIME(YTIME);
VFuelPriSubCarVal.FX(allCy,SBS,EF,YTIME)$TIME(YTIME) = VFuelPriSubCarVal.L(allCy,SBS,EF,YTIME)$TIME(YTIME);
...
VConsFuelNoHeat.FX(runCy,DSBS,EF,YTIME)$TIME(YTIME) = VConsFuelNoHeat.L(runCy,DSBS,EF,YTIME)$TIME(YTIME);

...
$setGlobal ClimateImpact    off          !! Use iam_compact to enable the module, the impacts include `cooling electricity demand increase in HOU/SE`, `CF decrease for hydro, fossils, biomass, and nuclear`, and optional `CAPEX increase`. See details in 12_ClimateImpact/iam_compact/input.

...
$setGlobal fCountries 'CHA,DEU,IND,USA' !! can be overwritten if VS Code Tasks are used
...
$evalGlobal fEndY 2025
$evalGlobal fStartY 2021
$evalGlobal fmaxLft 60
$evalGlobal fVintageStartY %fStartY% - %fmaxLft%

...
*---
V01StockPcYearly.LO(runCy,YTIME) = 0;
V01StockPcYearly.L(runCy,YTIME) = 0.5;
V01StockPcYearly.FX(runCy,YTIME)$(not An(YTIME)) = imActv(YTIME,runCy,"PC");
*---
V01ActivPassTrnsp.LO(runCy,TRANSE,YTIME) = 0;
V01ActivPassTrnsp.L(runCy,TRANSE,YTIME) = 1;
...
V01RateScrPc.L(runCy,TTECH,YTIME) = 0.1;
...
V01NumPcScrap.FX(runCy,YTIME)$DATAY(YTIME) = SUM(TTECH,V01RateScrPcTot.L(runCy,TTECH,YTIME) * V01StockPcYearlyTech.L(runCy,TTECH,YTIME)); 
*---
...
*---
V01PcOwnPcLevl.LO(runCy,YTIME) = 0;
...
*---
V01ConsTechTranspSectoral.LO(runCy,TRANSE,TTECH,EF,YTIME) = 0;
...
*---
VmDemFinEneTranspPerFuel.LO(runCy,TRANSE,EF,YTIME) = 0;
...
V01ShareTechTr.UP(runCy,TRANSE,TTECH,YTIME) = 1; 
*---
...
Q01ActivGoodsTransp(allCy,TRANSE,YTIME)$(TIME(YTIME) $TRANG(TRANSE) $runCy(allCy))..
         ...
         (
           ...
           * (i01Pop(YTIME,allCy)/i01Pop(YTIME-%fPeriodOfYears%,allCy))
         ...
         (
            ...
            (
              ...
              (V01ActivGoodsTransp(allCy,"GU",YTIME-%fPeriodOfYears%) + 1e6)
...
Q01GapTranspActiv(allCy,TRANSE,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
         ...
         +
         (
         ( [V01ActivPassTrnsp(allCy,TRANSE,YTIME) - V01ActivPassTrnsp(allCy,TRANSE,YTIME-%fPeriodOfYears%) + V01ActivPassTrnsp(allCy,TRANSE,YTIME-%fPeriodOfYears%)/
         (sum((TTECH)$SECTTECH(TRANSE,TTECH),VmLft(allCy,TRANSE,TTECH,YTIME-%fPeriodOfYears%))/TECHS(TRANSE))] +
          SQRT( SQR([V01ActivPassTrnsp(allCy,TRANSE,YTIME) - V01ActivPassTrnsp(allCy,TRANSE,YTIME-%fPeriodOfYears%) + V01ActivPassTrnsp(allCy,TRANSE,YTIME-%fPeriodOfYears%)/
          (sum((TTECH)$SECTTECH(TRANSE,TTECH),VmLft(allCy,TRANSE,TTECH,YTIME-%fPeriodOfYears%))/TECHS(TRANSE))]) + SQR(1e-4) ) )/2
         )$(TRANP(TRANSE) $(not sameas(TRANSE,"PC")))
         +
         (
         ( [V01ActivGoodsTransp(allCy,TRANSE,YTIME) - V01ActivGoodsTransp(allCy,TRANSE,YTIME-%fPeriodOfYears%) + V01ActivGoodsTransp(allCy,TRANSE,YTIME-%fPeriodOfYears%)/
         (sum((TTECH)$SECTTECH(TRANSE,TTECH),VmLft(allCy,TRANSE,TTECH,YTIME-%fPeriodOfYears%))/TECHS(TRANSE))] + SQRT( SQR([V01ActivGoodsTransp(allCy,TRANSE,YTIME) - V01ActivGoodsTransp(allCy,TRANSE,YTIME-%fPeriodOfYears%) + V01ActivGoodsTransp(allCy,TRANSE,YTIME-%fPeriodOfYears%)/
          (sum((TTECH)$SECTTECH(TRANSE,TTECH),VmLft(allCy,TRANSE,TTECH,YTIME-%fPeriodOfYears%))/TECHS(TRANSE))]) + SQR(1e-4) ) )/2
         )$TRANG(TRANSE);
...
Q01ConsSpecificFuel(allCy,TRANSE,TTECH,EF,YTIME)$(TIME(YTIME) $SECTTECH(TRANSE,TTECH) $TTECHtoEF(TTECH,EF) $runCy(allCy))..
         V01ConsSpecificFuel(allCy,TRANSE,TTECH,EF,YTIME)
                 =E=
        V01ConsSpecificFuel(allCy,TRANSE,TTECH,EF,YTIME-%fPeriodOfYears%) * 
        prod(KPDL,
          (
...
Q01ConsTechTranspSectoral(allCy,TRANSE,TTECH,EF,YTIME)$(TIME(YTIME) $SECTTECH(TRANSE,TTECH) $TTECHtoEF(TTECH,EF) $runCy(allCy))..
    V01ConsTechTranspSectoral(allCy,TRANSE,TTECH,EF,YTIME)
            =E=
    V01ConsTechTranspSectoral(allCy,TRANSE,TTECH,EF,YTIME-%fPeriodOfYears%) *
    (
      (
        (VmLft(allCy,TRANSE,TTECH,YTIME-%fPeriodOfYears%)-1) / 
        VmLft(allCy,TRANSE,TTECH,YTIME-%fPeriodOfYears%) *
        i01AvgVehCapLoadFac(allCy,TRANSE,"CAP",YTIME-%fPeriodOfYears%) *
        i01AvgVehCapLoadFac(allCy,TRANSE,"LF",YTIME-%fPeriodOfYears%) /
...
Q01StockPcYearlyTech(allCy,TTECH,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
      V01StockPcYearlyTech(allCy,TTECH,YTIME)
            =E=
      V01StockPcYearlyTech(allCy,TTECH,YTIME-%fPeriodOfYears%) * 
      (1 - V01RateScrPc(allCy,YTIME)) +
...
Q01NewRegPcYearly(allCy,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
        V01NewRegPcYearly(allCy,YTIME)
                =E=
        V01StockPcYearly(allCy,YTIME) - 
        V01StockPcYearly(allCy,YTIME-%fPeriodOfYears%) +
...
Q01ActivPassTrnsp(allCy,TRANSE,YTIME)$(TIME(YTIME) $TRANP(TRANSE) $runCy(allCy))..
      ...
      (  !! passenger cars
        ...
        [V01PcOwnPcLevl(allCy,YTIME)/V01PcOwnPcLevl(allCy,YTIME-%fPeriodOfYears%)]**imElastA(allCy,TRANSE,"b3",YTIME) *
        [i01GDPperCapita(YTIME,allCy)/i01GDPperCapita(YTIME-%fPeriodOfYears%,allCy)]**0.02
      )$sameas(TRANSE,"PC") +
      (  !! passenger aviation
        V01ActivPassTrnsp(allCy,TRANSE,YTIME-%fPeriodOfYears%) *
...
Q01NumPcScrap(allCy,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
      V01NumPcScrap(allCy,YTIME)
              =E=
      V01RateScrPc(allCy,YTIME) * V01StockPcYearly(allCy,YTIME-%fPeriodOfYears%);
...
Q01RateScrPc(allCy,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
        V01RateScrPc(allCy,YTIME)
            =E=
        V01RateScrPc(allCy,YTIME-%fPeriodOfYears%) *
        (
          i01GDPperCapita(YTIME,allCy) / 
          i01GDPperCapita(YTIME-%fPeriodOfYears%,allCy)
        ) ** 0.1;

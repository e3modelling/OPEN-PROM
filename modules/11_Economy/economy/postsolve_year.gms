...
VmSubsiDemTechAvail.L(runCyL,DSBS,TECH,YTIME+1) = pmSubsiDemTechAvail(runCyL,DSBS,TECH,YTIME);
VmSubsiDemITech.L(runCyL,DSBS,ITECH,YTIME+1) = pmSubsiDemITech(runCyL,DSBS,ITECH,YTIME);
VmSubsiDemTech.L(runCyL,DSBS,TECH,YTIME+1) = pmSubsiDemTech(runCyL,DSBS,TECH,YTIME);
VmSubsiSupTech.L(runCyL,STECH,YTIME+1) = pmSubsiSupTech(runCyL,STECH,YTIME);
VmSubsiCapCostTech.L(runCyL,DSBS,TECH,YTIME+1) = pmSubsiCapCostTech(runCyL,DSBS,TECH,YTIME);
VmSubsiCapCostSupply.L(runCyL,SSBS,STECH,YTIME+1) = pmSubsiCapCostSupply(runCyL,SSBS,STECH,YTIME);
VmNetSubsiTax.L(runCyL,YTIME+1) = pmNetSubsiTax(runCyL,YTIME);

...
Q11SubsiSupTechAvail(allCy,PGALL,YTIME)                       "Computes the state grants purposed to the support of each supply technology (Millions US$2015)"
...
Q11SubsiCapCostSupply(allCy,SSBS,PGALL,YTIME)
...
VmSubsiSupTechAvail(allCy,PGALL,YTIME)                        "State grants purposed to the support of each supply technology (Millions US$2015)"

...
p05DemTotH2(runCyL,YTIME)$TIME(YTIME) = VmDemTotH2.L(runCyL,YTIME)$TIME(YTIME);
p05DemSecH2(runCyL,SBS,YTIME)$TIME(YTIME) = VmDemSecH2.L(runCyL,SBS,YTIME)$TIME(YTIME);
p05ConsFuelTechH2Prod(runCyL,H2TECH,EF,YTIME)$TIME(YTIME) = VmConsFuelTechH2Prod.L(runCyL,H2TECH,EF,YTIME)$TIME(YTIME);
p05ConsFuelH2Prod(runCyL,EF,YTIME)$TIME(YTIME) = VmConsFuelH2Prod.L(runCyL,EF,YTIME)$TIME(YTIME);

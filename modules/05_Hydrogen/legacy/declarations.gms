...
iSalesH2Station                                "annual sales of a hydrogen service station in ktoe" /2.26/
iLenH2StationConn                              "length of pipes connection service stations with the ring in km per station" /2/
iDelivH2Turnpike                               "stylised annual hydrogen delivery in turnpike pipeline in ktoe" /275/
;

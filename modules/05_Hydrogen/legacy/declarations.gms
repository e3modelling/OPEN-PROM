...
Variables
V05GapShareH2Tech(allCy, H2TECH, YTIME)          "Shares of H2 production technologies in new market competition 1"
...
Equations
Q05GapShareH2Tech(allCy, H2TECH, YTIME)          "Equation for calculating the shares of technologies in hydrogen gap using Weibull equations 1"

...
V05GapShareH2Tech1.L(runCyL,H2TECH,YTIME+1) = p05GapShareH2Tech1(runCy,H2TECH,YTIME);
V05GapShareH2Tech2.L(runCyL,H2TECH,YTIME+1) = p05GapShareH2Tech2(runCy,H2TECH,YTIME);
V05CapScrapH2ProdTech.L(runCyL,H2TECH,YTIME+1) = p05CapScrapH2ProdTech(runCy,H2TECH,YTIME);
V05PremRepH2Prod.L(runCyL,H2TECH,YTIME+1) = p05PremRepH2Prod(runCy,H2TECH,YTIME);
V05ScrapLftH2Prod.L(runCyL,H2TECH,YTIME+1) = p05ScrapLftH2Prod(runCy,H2TECH,YTIME);
V05DemGapH2.L(runCyL,YTIME+1) = p05DemGapH2(runCy,YTIME);
V05CostProdH2Tech.L(runCyL,H2TECH,YTIME+1) = p05CostProdH2Tech(runCy,H2TECH,YTIME);
V05CostVarProdH2Tech.L(runCyL,H2TECH,YTIME+1) = p05CostVarProdH2Tech(runCy,H2TECH,YTIME);
V05ShareCCSH2Prod.L(runCyL,H2TECH,YTIME+1) = p05ShareCCSH2Prod(runCy,H2TECH,YTIME);
V05ShareNoCCSH2Prod.L(runCyL,H2TECH,YTIME+1) = p05ShareNoCCSH2Prod(runCy,H2TECH,YTIME);
V05AcceptCCSH2Tech.L(runCyL,YTIME+1) = p05AcceptCCSH2Tech(runCy,YTIME);
V05CostProdCCSNoCCSH2Prod.L(runCyL,H2TECH,YTIME+1) = p05CostProdCCSNoCCSH2Prod(runCy,H2TECH,YTIME);
V05CaptRateH2.L(runCyL,H2TECH,YTIME+1) = p05CaptRateH2(runCy,H2TECH,YTIME);
VmDemTotH2.L(runCyL,YTIME+1) = pmDemTotH2(runCy,YTIME);
VmProdH2.L(runCyL,H2TECH,YTIME+1) = pmProdH2(runCy,H2TECH,YTIME);
VmConsFuelTechH2Prod.L(runCyL,H2TECH,EF,YTIME+1) = pmConsFuelTechH2Prod(runCy,H2TECH,EF,YTIME);
VmDemSecH2.L(runCyL,SBS,YTIME+1) = pmDemSecH2(runCy,SBS,YTIME);
VmCostAvgProdH2.L(runCyL,YTIME+1) = pmCostAvgProdH2(runCy,YTIME);
VmConsFuelH2Prod.L(runCyL,EF,YTIME+1) = pmConsFuelH2Prod(runCy,EF,YTIME);
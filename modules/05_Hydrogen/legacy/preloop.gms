...
V05CostProdH2Tech.FX(runCy,H2TECH,YTIME)$DATAY(YTIME) = 
(
  imDisc(runCy,"H2P",YTIME) * 
  exp(imDisc(runCy,"H2P",YTIME)* i05ProdLftH2(H2TECH,YTIME)) /
  (exp(imDisc(runCy,"H2P",YTIME) * i05ProdLftH2(H2TECH,YTIME))-1) * 
  (
    i05CostCapH2Prod(runCy,H2TECH,YTIME) +
    i05CostFOMH2Prod(runCy,H2TECH,YTIME) +
    i05CostVOMH2Prod(runCy,H2TECH,YTIME)
  ) +
  V04CapexFixCostPG.L(runCy,"PGSOL",YTIME)$sameas(H2TECH,"wes") + 
  V04CapexFixCostPG.L(runCy,"PGAWNO",YTIME)$sameas(H2TECH,"wew")
...
p05GapShareH2Tech1(runCy,H2TECH,YTIME) = V05GapShareH2Tech1.L(runCy,H2TECH,YTIME-1);
p05GapShareH2Tech2(runCy,H2TECH,YTIME) = V05GapShareH2Tech2.L(runCy,H2TECH,YTIME-1);
p05CapScrapH2ProdTech(runCy,H2TECH,YTIME) = V05CapScrapH2ProdTech.L(runCy,H2TECH,YTIME-1);
p05PremRepH2Prod(runCy,H2TECH,YTIME) = V05PremRepH2Prod.L(runCy,H2TECH,YTIME-1);
p05ScrapLftH2Prod(runCy,H2TECH,YTIME) = V05ScrapLftH2Prod.L(runCy,H2TECH,YTIME-1);
p05DemGapH2(runCy,YTIME) = V05DemGapH2.L(runCy,YTIME-1);
p05CostProdH2Tech(runCy,H2TECH,YTIME) = V05CostProdH2Tech.L(runCy,H2TECH,YTIME-1);
p05CostVarProdH2Tech(runCy,H2TECH,YTIME) = V05CostVarProdH2Tech.L(runCy,H2TECH,YTIME-1);
p05ShareCCSH2Prod(runCy,H2TECH,YTIME) = V05ShareCCSH2Prod.L(runCy,H2TECH,YTIME-1);
p05ShareNoCCSH2Prod(runCy,H2TECH,YTIME) = V05ShareNoCCSH2Prod.L(runCy,H2TECH,YTIME-1);
p05AcceptCCSH2Tech(runCy,YTIME) = V05AcceptCCSH2Tech.L(runCy,YTIME-1);
p05CostProdCCSNoCCSH2Prod(runCy,H2TECH,YTIME) = V05CostProdCCSNoCCSH2Prod.L(runCy,H2TECH,YTIME-1);
p05CaptRateH2(runCy,H2TECH,YTIME) = V05CaptRateH2.L(runCy,H2TECH,YTIME-1);
pmDemTotH2(runCy,YTIME) = VmDemTotH2.L(runCy,YTIME-1);
pmProdH2(runCy,H2TECH,YTIME) = VmProdH2.L(runCy,H2TECH,YTIME-1);
pmConsFuelTechH2Prod(runCy,H2TECH,EF,YTIME) = VmConsFuelTechH2Prod.L(runCy,H2TECH,EF,YTIME-1);
pmDemSecH2(runCy,SBS,YTIME) = VmDemSecH2.L(runCy,SBS,YTIME-1);
pmCostAvgProdH2(runCy,YTIME) = VmCostAvgProdH2.L(runCy,YTIME-1);
pmConsFuelH2Prod(runCy,EF,YTIME) = VmConsFuelH2Prod.L(runCy,EF,YTIME-1);

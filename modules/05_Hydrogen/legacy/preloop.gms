...
p05GapShareH2Tech2(runCy,H2TECH,YTIME)$(DATAY(YTIME)) = 0;
p05CapScrapH2ProdTech(runCy,H2TECH,YTIME)$(DATAY(YTIME)) = 0;
p05PremRepH2Prod(runCy,H2TECH,YTIME)$(DATAY(YTIME) and not H2TECHPM(H2TECH)) = 1;
p05PremRepH2Prod(runCy,H2TECH,YTIME)$(DATAY(YTIME) and H2TECHPM(H2TECH)) = 0;
p05ScrapLftH2Prod(runCy,H2TECH,YTIME)$(DATAY(YTIME) and i05ProdLftH2(H2TECH,YTIME)) = 1 / i05ProdLftH2(H2TECH,YTIME);
p05DemGapH2(runCy,YTIME)$(DATAY(YTIME)) = 0;
p05CostVarProdH2Tech(runCy,H2TECH,YTIME)$(DATAY(YTIME)) = V05CostVarProdH2Tech.L(runCy,H2TECH,YTIME);

...
*---
P05ScrapLftH2Prod(runCy,H2TECH,YTIME)$(TIME(YTIME) and (ord(YTIME)>14+i05ProdLftH2(H2TECH,YTIME))) = 1/i05ProdLftH2(H2TECH,YTIME);
P05ScrapLftH2Prod(runCy,H2TECH,YTIME)$DATAY(YTIME) = 1/i05ProdLftH2(H2TECH,YTIME);
*---

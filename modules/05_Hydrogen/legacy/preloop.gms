...
p05ProdH2(runCy,H2TECH,YTIME)$DATAY(YTIME) = VmProdH2.L(runCy,H2TECH,YTIME);
...
p05CostProdCCSNoCCSH2Prod(runCy,H2TECH,YTIME)$DATAY(YTIME) = V05CostProdCCSNoCCSH2Prod.L(runCy,H2TECH,YTIME);
p05CostAvgProdH2(runCy,YTIME)$DATAY(YTIME) = VmCostAvgProdH2.L(runCy,YTIME);

...
VmConsFuelTechH2Prod.L(runCy,H2TECH,EF,"%fBaseY%")$(H2TECHEFtoEF(H2TECH,EF)) = (VmProdH2.L(runCy,H2TECH,"%fBaseY%")/i05EffH2Prod(runCy,H2TECH,"%fBaseY%"));
...
V05CostAvgProdH2.FX(runCy,YTIME)$(not An(YTIME)) = 0;
*---

...
V05GapShareH2Tech2.FX(runCy,H2TECH,YTIME)$DATAY(YTIME) = 1e-5;
*---
...
V05ShareCCSH2Prod.FX(runCy,H2TECH,YTIME)$DATAY(YTIME) = 1e-5;
*---
V05ShareNoCCSH2Prod.L(runCy,H2TECH,YTIME) = 2;
V05ShareNoCCSH2Prod.FX(runCy,H2TECH,YTIME)$DATAY(YTIME) = 1e-5;
*---
...
V05CostProdCCSNoCCSH2Prod.FX(runCy,H2TECH,YTIME)$DATAY(YTIME) = 1e-5;
*---

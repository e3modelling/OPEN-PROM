...
iCaptRateH2Prod(runCy,H2TECH,YTIME)=H2TECH_DATA(H2TECH,"CR");
*---
...
iH2Adopt(runCy,"b",YTIME)=H2INFR_OTHER(runCy,"b");
iH2Adopt(runCy,"mid",YTIME)=H2INFR_OTHER(runCy,"mid");
*---
...
iCostCapH2Prod(runCy,H2TECH,"2000")=H2TECH_DATA(H2TECH,"IC_00");
iCostCapH2Prod(runCy,H2TECH,"2025")=H2TECH_DATA(H2TECH,"IC_25");
iCostCapH2Prod(runCy,H2TECH,"2050")=H2TECH_DATA(H2TECH,"IC_50");
...
iCostFOMH2Prod(runCy,H2TECH,"2000")=H2TECH_DATA(H2TECH,"FC_00");
iCostFOMH2Prod(runCy,H2TECH,"2025")=H2TECH_DATA(H2TECH,"FC_25");
iCostFOMH2Prod(runCy,H2TECH,"2050")=H2TECH_DATA(H2TECH,"FC_50");
...
iCostVOMH2Prod(runCy,H2TECH,"2000")=H2TECH_DATA(H2TECH,"VC_00");
iCostVOMH2Prod(runCy,H2TECH,"2025")=H2TECH_DATA(H2TECH,"VC_25");
iCostVOMH2Prod(runCy,H2TECH,"2050")=H2TECH_DATA(H2TECH,"VC_50");
...
iEffH2Prod(runCy,H2TECH,"2000")=H2TECH_DATA(H2TECH,"EFF_00");
iEffH2Prod(runCy,H2TECH,"2025")=H2TECH_DATA(H2TECH,"EFF_25");
iEffH2Prod(runCy,H2TECH,"2050")=H2TECH_DATA(H2TECH,"EFF_50");
...
iCostInvH2Transp(runCy,INFRTECH,"2000")=H2INFRA_DATA(INFRTECH,"IC_00");
iCostInvH2Transp(runCy,INFRTECH,"2025")=H2INFRA_DATA(INFRTECH,"IC_25");
iCostInvH2Transp(runCy,INFRTECH,"2050")=H2INFRA_DATA(INFRTECH,"IC_50");
...
iEffH2Transp(runCy,INFRTECH,"2000")=H2INFRA_DATA(INFRTECH,"EFF_00");
iEffH2Transp(runCy,INFRTECH,"2025")=H2INFRA_DATA(INFRTECH,"EFF_25");
iEffH2Transp(runCy,INFRTECH,"2050")=H2INFRA_DATA(INFRTECH,"EFF_50");
...
iConsSelfH2Transp(runCy,INFRTECH,"2000")=H2INFRA_DATA(INFRTECH,"SELF_00");
iConsSelfH2Transp(runCy,INFRTECH,"2025")=H2INFRA_DATA(INFRTECH,"SELF_25");
iConsSelfH2Transp(runCy,INFRTECH,"2050")=H2INFRA_DATA(INFRTECH,"SELF_50");
...
iKmFactH2Transp(runCy,INFRTECH) = sum(alllabels$INFRTECHLAB(INFRTECH,alllabels), H2INFR_OTHER(runCy,alllabels));
...
iPolH2AreaMax(runCy) = H2INFR_OTHER(runCy,"MAXAREA");

parameter iHabAreaCountry(allCy)                    "Inhabitable land in a country";
iHabAreaCountry(runCy) = H2INFR_OTHER(runCy,"AREA");
*---

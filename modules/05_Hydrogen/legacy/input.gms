...
iProdLftH2(H2TECH)=iH2Production("LFT",H2TECH,YTIME);
*---
...
iTranspLftH2(INFRTECH)=iH2InfrCapCosts("LFT",INFRTECH,YTIME);
*---
...
iPipeH2Transp(INFRTECH) =  iH2InfrCapCosts("H2KMTOE",INFRTECH,YTIME);

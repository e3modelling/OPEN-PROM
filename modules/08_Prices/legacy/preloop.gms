...
*---
VmPriceFuelSubsecCarVal.L(runCy,SBS,EF,YTIME)$SECTTECH(SBS,EF) = 1.5;
...
* author=giannou
VmPriceFuelSubsecCarVal.FX(runCy,"PG","NUC",YTIME) = 0.02; !! fixed price for nuclear fuel to k$2015/toe
VmPriceFuelSubsecCarVal.FX(runCy,"H2P","NUC",YTIME) = 0.02; !! fixed price for nuclear fuel to k$2015/toe

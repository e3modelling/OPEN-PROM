...
V08PriceFuelSepCarbonWght.L(runCy,DSBS,EF,YTIME+1) = p08PriceFuelSepCarbonWght(runCy,DSBS,EF,YTIME);
VmPriceFuelSubsecCarVal.L(runCy,SBS,EF,YTIME+1) = pmPriceFuelSubsecCarVal(runCy,SBS,EF,YTIME);
VmPriceFuelAvgSub.L(runCy,DSBS,YTIME+1) = pmPriceFuelAvgSub(runCy,DSBS,YTIME);
VmPriceElecInd.L(runCy,TCHP,YTIME+1) = pmPriceElecInd(runCy,TCHP,YTIME);

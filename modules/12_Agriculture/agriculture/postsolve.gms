...
V12CostTotal.FX(runCyL,AGRI_MODES,AGRITECH,YTIME)$TIME(YTIME) = V12CostTotal.L(runCyL,AGRI_MODES,AGRITECH,YTIME)$TIME(YTIME);
V12CostFuel.FX(runCyL,AGRI_MODES,AGRITECH,YTIME)$TIME(YTIME) = V12CostFuel.L(runCyL,AGRI_MODES,AGRITECH,YTIME)$TIME(YTIME);
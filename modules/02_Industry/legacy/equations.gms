...
QConsFuel(allCy,DSBS,EF,YTIME)$(TIME(YTIME) $(not TRANSE(DSBS)) $SECTTECH(DSBS,EF) $(not HEATPUMP(EF)) $runCy(allCy))..
         ...
         (VConsFuelInclHP(allCy,DSBS,EF,YTIME) + VElecConsHeatPla(allCy,DSBS,YTIME))$ELCEF(EF) + VConsFuelH2Prod(allCy,EF,YTIME)$(H2PRODEF(EF)) ; !! + VConsFuelH2Prod(allCy, EF, YTIME)

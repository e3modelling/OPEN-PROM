...
*VSortTechVarCost.FX(runCyL,DSBS,rCon,YTIME)$TIME(YTIME) = VSortTechVarCost.L(runCyL,DSBS,rCon,YTIME)$TIME(YTIME);
*VShareTechNewEquip.FX(runCyL,DSBS,EF,YTIME)$TIME(YTIME) = VShareTechNewEquip.L(runCyL,DSBS,EF,YTIME)$TIME(YTIME);
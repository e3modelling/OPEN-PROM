...
p02GapUsefulDemSubsec(runCy,DSBS,YTIME) = V02GapUsefulDemSubsec.L(runCy,DSBS,YTIME);
p02CapCostTech(runCy,DSBS,ITECH,YTIME) = V02CapCostTech.L(runCy,DSBS,ITECH,YTIME);
p02VarCostTech(runCy,DSBS,ITECH,YTIME) = V02VarCostTech.L(runCy,DSBS,ITECH,YTIME);
p02CostTech(runCy,DSBS,ITECH,YTIME) = V02CostTech.L(runCy,DSBS,ITECH,YTIME);
p02ShareTechNewEquipUseful(runCy,DSBS,ITECH,YTIME) = V02ShareTechNewEquipUseful.L(runCy,DSBS,ITECH,YTIME);
p02EquipCapTechSubsec(runCy,DSBS,ITECH,YTIME) = V02EquipCapTechSubsec.L(runCy,DSBS,ITECH,YTIME);
p02UsefulElecNonSubIndTert(runCy,DSBS,YTIME) = V02UsefulElecNonSubIndTert.L(runCy,DSBS,YTIME);
p02FinalElecNonSubIndTert(runCy,DSBS,YTIME) = V02FinalElecNonSubIndTert.L(runCy,DSBS,YTIME);
p02IndxElecIndPrices(runCy,TCHP,YTIME) = V02IndxElecIndPrices.L(runCy,TCHP,YTIME);
p02IndAvrEffFinalUseful(runCy,DSBS,YTIME) = V02IndAvrEffFinalUseful.L(runCy,DSBS,YTIME);
p02PremScrpIndu(runCy,DSBS,ITECH,YTIME) = V02PremScrpIndu.L(runCy,DSBS,ITECH,YTIME);
p02RatioRem(runCy,DSBS,ITECH,YTIME) = V02RatioRem.L(runCy,DSBS,ITECH,YTIME);
pmConsFuel(runCy,DSBS,EF,YTIME) = VmConsFuel.L(runCy,DSBS,EF,YTIME);

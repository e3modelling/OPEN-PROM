...
V02EquipCapTechSubsec.FX(runCy,DSBS,ITECH,YTIME)$(SECTTECH(DSBS,ITECH) and not An(YTIME) and not TRANSE(DSBS) and sameas(ITECH,"TASHP")) = i02ShareElcHP(runCy,DSBS,YTIME) * i02ShareHP(runCy,ITECH,YTIME) * imFuelCons(runCy,DSBS,"ELC",YTIME) * (1-imShrNonSubElecInTotElecDem(runCy,DSBS));
V02EquipCapTechSubsec.FX(runCy,DSBS,ITECH,YTIME)$(SECTTECH(DSBS,ITECH) and not An(YTIME) and not TRANSE(DSBS) and sameas(ITECH,"TWSHP")) = i02ShareElcHP(runCy,DSBS,YTIME) * i02ShareHP(runCy,ITECH,YTIME) * imFuelCons(runCy,DSBS,"ELC",YTIME) * (1-imShrNonSubElecInTotElecDem(runCy,DSBS));
V02EquipCapTechSubsec.FX(runCy,DSBS,ITECH,YTIME)$(SECTTECH(DSBS,ITECH) and not An(YTIME) and not TRANSE(DSBS) and sameas(ITECH,"TGSHP")) = i02ShareElcHP(runCy,DSBS,YTIME) * i02ShareHP(runCy,ITECH,YTIME) * imFuelCons(runCy,DSBS,"ELC",YTIME) * (1-imShrNonSubElecInTotElecDem(runCy,DSBS));

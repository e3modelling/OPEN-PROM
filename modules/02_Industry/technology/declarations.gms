...
Q02VarCostTech(allCy,DSBS,ITECH,YTIME)                     "Compute variable cost of each technology per subsector (useful)"
Q02EmiCostTech(allCY,DSBS,ITECH,YTIME)                     "Compute emission's cost of each technology per subsector (useful)"
...
V02CapCostTech(allCy,DSBS,ITECH,YTIME)                     "capital cost of each technology per subsector (useful) (KUS$2015/toe)"
V02VarCostTech(allCy,DSBS,ITECH,YTIME)                     "variable cost of each technology per subsector (useful) (KUS$2015/toe)"
V02EmiCostTech(allCY,DSBS,ITECH,YTIME)                     "emission's cost of each technology per subsector (useful) (KUS$2015/toe)"
V02CostTech(allCy,DSBS,ITECH,YTIME)                        "total cost of each technology per subsector (useful) (KUS$2015/toe)"

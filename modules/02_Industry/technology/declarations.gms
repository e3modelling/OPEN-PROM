...
Q02CostElecProdCHP(allCy,DSBS,TCHP,YTIME)                   "Compute Cost of electricity production by CHP - NEEDED?"
...
Q02CostElcAvgProdCHP(allCy,TCHP,YTIME)                      "Compute Average Electricity production cost per CHP plant - NEEDED?"
;
...
V02CostElecProdCHP(allCy,DSBS,TCHP,YTIME)                   "Cost of electricity production by CHP - NEEDED?"
...
VmCostElcAvgProdCHP(allCy,TCHP,YTIME)                       "Average Electricity production cost per CHP plant - NEEDED?"
;
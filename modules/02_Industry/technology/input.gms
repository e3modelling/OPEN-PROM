...
i02LifChpPla(allCy,DSBS,TCHP)                               "Technical Lifetime for CHP plants (years)"
...
*---
i02LifChpPla(runCy,DSBS,TCHP) = imDataChpPowGen(TCHP,"LFT","2010");
*---
...
*---
i02BoiEffChp(runCy,TCHP,YTIME)            = imDataChpPowGen(TCHP,"BOILEFF",YTIME);
*---

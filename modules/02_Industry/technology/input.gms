...
table iECEMF(allCy,YTIME)   "Data for the share of water and space heating of total demand up to 2100"
$ondelim
$include "./iECEMF.csv"
$offdelim
;
...
table iHeatPumpMix(allCy,ITECH,YTIME)   "Data for the capacity factor of residential and commercial space heating technologies in 2024"
$ondelim
...
i02ShareHP(allCy,ITECH,YTIME) =   iHeatPumpMix(allCy,ITECH,YTIME) ;                       
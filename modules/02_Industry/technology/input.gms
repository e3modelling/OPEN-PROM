...
!!i02ScaleEndogScrap.FX(runCy,DSBS,ITECH,YTIME)$((INDDOM(DSBS) or sameas("NEN",DSBS) or sameas("PCH",DSBS)) and not EU28(runCy)) = 1;
...
i02CalibUsefulEnergy.FX(runCy,DSBS,YTIME)$((INDSE(DSBS) or sameas("NEN",DSBS) or sameas("PCH",DSBS)) and not EU28(runCy)) = 0;
$ENDIF.calib

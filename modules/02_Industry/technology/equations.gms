...
*' NEW SET TECHEF
Q02VarCostTech(allCy,DSBS,rCon,ITECH,YTIME)$(TIME(YTIME) $(not TRANSE(DSBS) and not sameas(DSBS,"DAC"))$(ord(rCon) le imNcon(DSBS)+1)$SECTTECH(DSBS,ITECH)$runCy(allCy))..

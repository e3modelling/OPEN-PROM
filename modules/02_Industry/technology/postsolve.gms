...
V02CostElecProdCHP.FX(runCyL,DSBS,TCHP,YTIME)$TIME(YTIME) = V02CostElecProdCHP.L(runCyL,DSBS,TCHP,YTIME)$TIME(YTIME);      
VmConsFuel.FX(runCyL,DSBS,EF,YTIME)$TIME(YTIME) = VmConsFuel.L(runCyL,DSBS,EF,YTIME)$TIME(YTIME);       
VmCostElcAvgProdCHP.FX(runCyL,TCHP,YTIME)$TIME(YTIME) = VmCostElcAvgProdCHP.L(runCyL,TCHP,YTIME)$TIME(YTIME);

...
p04CapElecNominal(allCy,PGALL,YTIME)                 "Snapshot of V04CapElecNominal for lagged references"
p04ShareTechPG(allCy,PGALL,YTIME)                    "Snapshot of V04ShareTechPG for lagged references"
p04IndxEndogScrap(allCy,PGALL,YTIME)                 "Snapshot of V04IndxEndogScrap for lagged references"
p04GapGenCapPowerDiff(allCy,YTIME)                   "Snapshot of V04GapGenCapPowerDiff for lagged references"
p04SharePowPlaNewEq(allCy,PGALL,YTIME)               "Snapshot of V04SharePowPlaNewEq for lagged references"
p04SortPlantDispatch(allCy,PGALL,YTIME)              "Snapshot of V04SortPlantDispatch for lagged references"
p04NewCapElec(allCy,PGALL,YTIME)                     "Snapshot of V04NewCapElec for lagged references"
p04NetNewCapElec(allCy,PGALL,YTIME)                  "Snapshot of V04NetNewCapElec for lagged references"
p04DemElecTot(allCy,YTIME)                           "Snapshot of V04DemElecTot for lagged references"
p04ProdElecEstCHP(allCy,TCHP,YTIME)                  "Snapshot of V04ProdElecEstCHP for lagged references"
p04CapexFixCostPG(allCy,PGALL,YTIME)                 "Snapshot of V04CapexFixCostPG for lagged references"
p04CapexRESRate(allCy,PGALL,YTIME)                   "Snapshot of V04CapexRESRate for lagged references"
p04CO2CaptRate(allCy,PGALL,YTIME)                    "Snapshot of V04CO2CaptRate for lagged references"
p04CCSRetroFit(allCy,PGALL,YTIME)                    "Snapshot of V04CCSRetroFit for lagged references"
p04ScrpRate(allCy,PGALL,YTIME)                       "Snapshot of V04ScrpRate for lagged references"
p04ProdElec(allCy,PGALL,YTIME)                       "Snapshot of VmProdElec for lagged references"
p04ConsFuelElecProd(allCy,EFS,YTIME)                 "Snapshot of VmConsFuelElecProd for lagged references"

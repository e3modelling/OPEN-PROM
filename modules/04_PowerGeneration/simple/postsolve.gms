...
V04CostCapTech.FX(runCyL,PGALL,YTIME)$TIME(YTIME) = V04CostCapTech.L(runCyL,PGALL,YTIME);
V04CostVarTech.FX(runCyL,PGALL,YTIME)$TIME(YTIME) = V04CostVarTech.L(runCyL,PGALL,YTIME);
V04CostEmiTech.FX(runCyL,PGALL,YTIME)$TIME(YTIME) = V04CostEmiTech.L(runCyL,PGALL,YTIME);

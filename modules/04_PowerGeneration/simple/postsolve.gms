...
V04ShareSatPG.FX(runCy,PGALL,YTIME)$TIME(YTIME) = V04ShareSatPG.L(runCy,PGALL,YTIME)$TIME(YTIME);
V04CostHourProdInvDec.FX(runCy,PGALL,YTIME)$TIME(YTIME) = V04CostHourProdInvDec.L(runCy,PGALL,YTIME)$TIME(YTIME);

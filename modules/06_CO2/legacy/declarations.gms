...
Q06GrossCapDAC(allCy,DACTECH,YTIME)                        "Computes CAPEX of DAC technologies with learning curve (US$2015/tCO2)"
Q06FixOandMDAC(allCy,DACTECH,YTIME)                        "Computes Fixed and O&M costs of DAC technologies with learning curve (US$2015/tCO2)"
Q06LvlCostDAC(allCy,DACTECH,YTIME)                         "Calculates the CAPEX and the Fixed Costs of DAC capacity regionally (US$2015/tCO2)"
Q06VarCostDAC(allCy,DACTECH,YTIME)                         "Computes variable costs of DAC technologies including carbon storage costs, with learning curve (US$2015/tCO2)"
...
Q06CapDAC(allCy,DACTECH,YTIME)                             "Computes the DAC installed capacity annually and regionally (tCO2)"
...
S06MatFacDAC                                                "Maturity factor of DAC technology expressing its elasticity in implementation regarding its financial sustainability" /0.43/

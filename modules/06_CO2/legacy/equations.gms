...
Q06CaptCummCO2(allCy,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
    V06CaptCummCO2(allCy,YTIME) 
      =E= 
    V06CaptCummCO2(allCy,YTIME-%fPeriodOfYears%) +
...
Q06CstCO2SeqCsts(allCy,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
    ...
    i06ElastCO2Seq(allCy,"mc_b") *
    exp(
      (V06CaptCummCO2(allCy,YTIME-%fPeriodOfYears%) - V06CapCDR(allCy,"TEW",YTIME-%fPeriodOfYears%) * 1e-6) / 
...
Q06GrossCapDAC(CDRTECH,YTIME)$(TIME(YTIME))..
    ...
    0.5 * 
    (
      (i06GrossCapDAC(CDRTECH) * (sum(allCy$runCyL(allCy),V06CapCDR(allCy,CDRTECH,YTIME-%fPeriodOfYears%))) ** (log(0.97)/log(2))) +
...
Q06FixOandMDAC(CDRTECH,YTIME)$(TIME(YTIME))..
    ...
    0.5 * 
    (
      (i06FixOandMDAC(CDRTECH) * (sum(allCy$runCyL(allCy),V06CapCDR(allCy,CDRTECH,YTIME-%fPeriodOfYears%))) ** (log(0.97)/log(2))) +
...
Q06VarCostDAC(CDRTECH,YTIME)$(TIME(YTIME))..
    ...
    0.5 * 
    (
      (i06VarCostDAC(CDRTECH) * (sum(allCy$runCyL(allCy),V06CapCDR(allCy,CDRTECH,YTIME-%fPeriodOfYears%))) ** (log(0.97)/log(2))) +
...
Q06CapCDR(allCy,CDRTECH,YTIME)$(TIME(YTIME)$(runCy(allCy)))..
          V06CapCDR(allCy,CDRTECH,YTIME)
            =E=
          V06CapCDR(allCy,CDRTECH,YTIME-%fPeriodOfYears%) * (1 + V06CapFacNewDAC(allCy,CDRTECH,YTIME)) +

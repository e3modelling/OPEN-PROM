...
p06CaptCummCO2(runCy,YTIME)$DATAY(YTIME) = V06CaptCummCO2.L(runCy,YTIME);
p06CapCDR(runCy,CDRTECH,YTIME)$DATAY(YTIME) = V06CapCDR.L(runCy,CDRTECH,YTIME);
p06LvlCostDAC(runCy,CDRTECH,YTIME)$DATAY(YTIME) = V06LvlCostDAC.L(runCy,CDRTECH,YTIME);
p06CapFacNewDAC(runCy,CDRTECH,YTIME)$DATAY(YTIME) = V06CapFacNewDAC.L(runCy,CDRTECH,YTIME);
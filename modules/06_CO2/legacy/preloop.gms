...
p06CO2CaptureCCS(runCy,SBS,EFS,YTIME) = V06CO2CaptureCCS.L(runCy,SBS,EFS,YTIME-1);
p06CaptCummCO2(runCy,YTIME) = V06CaptCummCO2.L(runCy,YTIME-1);
p06CaptCummCO2Glob(YTIME) = V06CaptCummCO2Glob.L(YTIME-1);
p06GrossCapDAC(CDRTECH,YTIME) = V06GrossCapDAC.L(CDRTECH,YTIME-1);
p06FixOandMDAC(CDRTECH,YTIME) = V06FixOandMDAC.L(CDRTECH,YTIME-1);
p06VarCostDAC(CDRTECH,YTIME) = V06VarCostDAC.L(CDRTECH,YTIME-1);
p06LvlCostDAC(runCy,CDRTECH,YTIME) = V06LvlCostDAC.L(runCy,CDRTECH,YTIME-1);
p06ProfRateDAC(runCy,CDRTECH,YTIME) = V06ProfRateDAC.L(runCy,CDRTECH,YTIME-1);
p06CapFacNewDAC(runCy,CDRTECH,YTIME) = V06CapFacNewDAC.L(runCy,CDRTECH,YTIME-1);
p06CapCDR(runCy,CDRTECH,YTIME) = V06CapCDR.L(runCy,CDRTECH,YTIME-1);
pmCstCO2SeqCsts(runCy,YTIME) = VmCstCO2SeqCsts.L(runCy,YTIME-1);
pmConsFuelTechCDRProd(runCy,CDRTECH,EFS,YTIME) = VmConsFuelTechCDRProd.L(runCy,CDRTECH,EFS,YTIME-1);
pmConsFuelCDRProd(runCy,EFS,YTIME) = VmConsFuelCDRProd.L(runCy,EFS,YTIME-1);

...
V06GrossCapDAC.L(CDRTECH,YTIME) = 0;
V06FixOandMDAC.L(CDRTECH,YTIME) = 0;
V06VarCostDAC.L(CDRTECH,YTIME) = 0;
VmConsFuelTechCDRProd.L(runCy,CDRTECH,EFS,YTIME) = 0;
VmConsFuelCDRProd.L(runCy,EFS,YTIME) = 0;

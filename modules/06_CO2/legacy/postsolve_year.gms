...
V06CO2CaptureCCS.L(runCyL,SBS,EFS,YTIME+1) = p06CO2CaptureCCS(runCy,SBS,EFS,YTIME);
V06CaptCummCO2.L(runCyL,YTIME+1) = p06CaptCummCO2(runCy,YTIME);
...
V06LvlCostDAC.L(runCyL,CDRTECH,YTIME+1) = p06LvlCostDAC(runCy,CDRTECH,YTIME);
V06ProfRateDAC.L(runCyL,CDRTECH,YTIME+1) = p06ProfRateDAC(runCy,CDRTECH,YTIME);
V06CapFacNewDAC.L(runCyL,CDRTECH,YTIME+1) = p06CapFacNewDAC(runCy,CDRTECH,YTIME);
V06CapCDR.L(runCyL,CDRTECH,YTIME+1) = p06CapCDR(runCy,CDRTECH,YTIME);
VmCstCO2SeqCsts.L(runCyL,YTIME+1) = pmCstCO2SeqCsts(runCy,YTIME);
VmConsFuelTechCDRProd.L(runCyL,CDRTECH,EFS,YTIME+1) = pmConsFuelTechCDRProd(runCy,CDRTECH,EFS,YTIME);
VmConsFuelCDRProd.L(runCyL,EFS,YTIME+1) = pmConsFuelCDRProd(runCy,EFS,YTIME);

...
p06CO2CaptureCCS(runCyL,SBS,EF,YTIME)$TIME(YTIME) = V06CO2CaptureCCS.L(runCyL,SBS,EF,YTIME)$TIME(YTIME);
...
p06CstCO2SeqCsts(runCyL,YTIME)$TIME(YTIME) = VmCstCO2SeqCsts.L(runCyL,YTIME)$TIME(YTIME);
p06ConsFuelTechCDRProd(runCyL,CDRTECH,EF,YTIME)$TIME(YTIME) = VmConsFuelTechCDRProd.L(runCyL,CDRTECH,EF,YTIME)$TIME(YTIME);
p06ConsFuelCDRProd(runCyL,EF,YTIME)$TIME(YTIME) = VmConsFuelCDRProd.L(runCyL,EF,YTIME)$TIME(YTIME);

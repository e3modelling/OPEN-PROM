...
;
*---
table iInpTransfTherm(allCy,EFS,YTIME) "Historic data of MVInpTransfTherm (Transformation input to thermal power plants) (Mtoe)"
$ondelim
...
iInpTransfTherm(allCy,EFS,YTIME)                  "Historic data of MVInpTransfTherm (Transformation input to thermal power plants) (Mtoe)"
;
*---

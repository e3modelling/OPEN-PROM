...
*---
V03CapRef.LO(runCy,YTIME) = 0;
*V03CapRef.L(runCy,YTIME) = 0.1;
V03CapRef.FX(runCy,YTIME)$DATAY(YTIME) = i03RefCapacity(runCy,YTIME);
*---
V03OutTransfRefSpec.LO(runCy,EFS,YTIME) = 0;
*V03OutTransfRefSpec.L(runCy,EFS,YTIME) = 0.1;
V03OutTransfRefSpec.FX(runCy,EFS,YTIME)$DATAY(YTIME) = i03TransfOutputRef(runCy,EFS,YTIME);
V03OutTransfRefSpec.FX(runCy,EFS,YTIME)$(i03TransfOutputRef(runCy,EFS,"%fBaseY%") eq 0) = 0;
*---
*V03ConsGrssInlNotEneBranch.LO(runCy,EFS,YTIME) = 0;
...
*---
V03InputTransfRef.LO(runCy,"CRO",YTIME) = 0;

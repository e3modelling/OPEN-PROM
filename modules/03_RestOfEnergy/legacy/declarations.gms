...
p03ImpNetEneBrnch(allCy,EFS,YTIME)    "Snapshot of VmImpNetEneBrnch (Mtoe)"
p03ConsFiEneSec(allCy,SSBS,EFS,YTIME) "Snapshot of VmConsFiEneSec (Mtoe)"
p03ConsFinNonEne(allCy,EFS,YTIME)     "Snapshot of VmConsFinNonEne (Mtoe)"
p03LossesDistr(allCy,EFS,YTIME)       "Snapshot of VmLossesDistr (Mtoe)"

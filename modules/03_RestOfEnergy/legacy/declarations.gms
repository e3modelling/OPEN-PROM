...
Q03TransfInputDHPlants(allCy,EFS,YTIME)                    "Compute the transformation input to district heating plants"
Q03TransfInputCHPlants(allCy,EFS,YTIME)                    "Compute the transformation input to CHPs"
...
VmConsFinEneCountry(allCy,EFS,YTIME)                       "Total final energy consumption (Mtoe)"

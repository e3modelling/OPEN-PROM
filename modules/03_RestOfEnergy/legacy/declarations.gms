...
Q03OutTransfNuclear(allCy,EFS,YTIME)	                   "Compute transformation output from nuclear plants"
Q03InpTransfNuclear(allCy,EFS,YTIME)	                   "Compute transformation input to nuclear plants"
...
V03OutTransfNuclear(allCy,EFS,YTIME)	                   "Transformation output from nuclear plants (Mtoe)"
V03InpTransfNuclear(allCy,EFS,YTIME)	                   "Transformation input to nuclear plants (Mtoe)"

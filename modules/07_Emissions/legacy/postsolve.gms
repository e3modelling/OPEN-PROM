...
p07RedAbsBySrcRegTim(E07SrcMacAbate,runCyL,YTIME)$TIME(YTIME) = V07RedAbsBySrcRegTim(E07SrcMacAbate,runCyL,YTIME)$TIME(YTIME);
p07EmiActBySrcRegTim(E07SrcMacAbate,runCyL,YTIME)$TIME(YTIME) = V07EmiActBySrcRegTim(E07SrcMacAbate,runCyL,YTIME)$TIME(YTIME);
p07CostAbateBySrcRegTim(E07SrcMacAbate,runCyL,YTIME)$TIME(YTIME) = V07CostAbateBySrcRegTim(E07SrcMacAbate,runCyL,YTIME)$TIME(YTIME);

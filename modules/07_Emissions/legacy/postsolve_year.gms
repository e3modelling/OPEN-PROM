...
V07GrossEmissCO2Supply.L(runCy,SSBS,YTIME+1) = p07GrossEmissCO2Supply(runCy,SSBS,YTIME);
...
V07GrossEmissCO2Demand.L(runCy,DSBS,YTIME+1) = p07GrossEmissCO2Demand(runCy,DSBS,YTIME);
V07EmissionsNet.L(runCy,YTIME+1) = p07EmissionsNet(runCy,YTIME);
V07EmissionsNetPart.L(runCy,YTIME+1) = p07EmissionsNetPart(runCy,YTIME);

...
$IF %Calibration% == off qDemFinEneSubTransp                 !! vDemFinEneSubTransp(runCy,TRANSE,YTIME)
...
$IF %Calibration% == off qConsTotElecInd                     !! vConsTotElecInd(runCy,YTIME)
$IF %Calibration% == off qDemFinSubFuelInd                   !! vDemFinSubFuelInd(runCy,YTIME)
...
$IF %Calibration% == off qConsTotFinEne                      !! vConsTotFinEne(YTIME)

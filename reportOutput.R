...
reportPrice <- function() {
  ...
  menaregs <- intersect(getRegions(z),getRegions(VElecPriInduResConsu))
  #choose Industrial consumer /i/
  ...
  write.report(z[menaregs,years,],file="reporting.mif",model="MENA-EDS",unit="Euro2005/KWh",append=TRUE,scenario=scenario_name)
  ...
  x <- x[, year,]
  # write data in mif file
  write.report(x[intersect(getRegions(x),regs),,],file="reporting.mif",model="ENERDATA",unit="Euro2005/KWh",append=TRUE,scenario=scenario_name)
  ...
  menaregs <- intersect(getRegions(MENA_EDS_pric),getRegions(price))
  ...
  write.report(MENA_EDS_pric[menaregs,years,],file="reporting.mif",model="MENA-EDS",unit="various",append=TRUE,scenario=scenario_name)
  write.report(a_ener[intersect(regs,getRegions(a_ener)),year,],file="reporting.mif",model="ENERDATA",unit="various",append=TRUE,scenario=scenario_name)

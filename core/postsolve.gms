...
$else.calib
execute_unload "outputData.gdx", ODummyObj, VmCapElecTotEst, P04CapElecNominal, VmConsFuel, VmCapElec, VmProdElec, VmPriceFuelSubsecCarVal, VmPriceElecIndResConsu;
$endif.calib

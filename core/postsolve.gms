...
execute_unload "outputCalib.gdx", ODummyObj, VmCapElec, V04CapElecNominal, VmProdElec, V04ProdElecEstCHP, i04MatFacPlaAvailCap, i04MatureFacPlaDisp, V04SharePowPlaNewEq, t04SharePowPlaNewEq, V04ScalWeibullSum, V04CostHourProdInvDec, V04RenTechMatMult, i04AvailRate, V04DemElecTot, t04DemElecTot,iCarbValYrExog;
$else.calib

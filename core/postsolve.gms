...
execute_unload "outputCalib.gdx", ODummyObj, VmCapElec, V04CapElecNominal, VmProdElec, V04ProdElecEstCHP, i04MatFacPlaAvailCap, imMatrFactor, V04SharePowPlaNewEq, t04SharePowPlaNewEq, V04ShareTechPG, V04CostHourProdInvDec, V04ShareSatPG, V01ShareTechTr, i04AvailRate, V04DemElecTot, t01StockPC, t04DemElecTot, iCarbValYrExog;
$else.calib
...
execute 'gdxdump outputCalib.gdx output=imMatrFactor.csv symb=imMatrFactor cDim=y format=csv';
$endif.calib
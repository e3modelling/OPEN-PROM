...
execute_unload "outputData.gdx", ODummyObj, MVCapElecTotEst, MVPeakLoad, MVConsFuel, MVCapElec, VCapElecNominal, MVProdElec, MVBaseLoad, MVPriceFuelSubsecCarVal, MVPriceElecIndResConsu;

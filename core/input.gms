...
imMatrFactor(runCy,DSBS,"TGDO",YTIME)$((ord(YTIME) > 12) and TRANSE(DSBS)) = 0.5;
imMatrFactor(runCy,DSBS,"TGSL",YTIME)$((ord(YTIME) > 12) and TRANSE(DSBS)) = 0.5;
imMatrFactor(runCy,DSBS,"TELC",YTIME)$((ord(YTIME) > 12) and TRANSE(DSBS)) = 3;
imMatrFactor("CHA",DSBS,"TELC",YTIME)$((ord(YTIME) > 12) and TRANSE(DSBS)) = 8;
...
imMatrFactor(runCy,DSBS,"TELC",YTIME)$(ord(YTIME) > 40 and TRANSE(DSBS)) = 11;
imMatrFactor(runCy,DSBS,"TELC",YTIME)$(ord(YTIME) > 40 and TRANSE(DSBS)) = 11;
imMatrFactor(runCy,DSBS,"TNGSCCS",YTIME)$((ord(YTIME) > 12) and INDSE(DSBS)) = 1;
imMatrFactor(runCy,DSBS,"THCLCCS",YTIME)$((ord(YTIME) > 12) and INDSE(DSBS)) = 1;
imMatrFactor(runCy,DSBS,"TELC",YTIME)$(ord(YTIME) > 12 and DOMSE(DSBS)) = 20;
imMatrFactor(runCy,DSBS,"TBMSWAS",YTIME)$(ord(YTIME) > 12 and DOMSE(DSBS)) = 0.001;
...
imMatrFactor(runCy,DSBS,"TELC",YTIME)$(ord(YTIME) > 12 and INDSE(DSBS)) = 4;
imMatrFactor(runCy,DSBS,"TH2F",YTIME)$(ord(YTIME) > 12 and INDSE(DSBS)) = 20;
